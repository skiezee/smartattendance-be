use actix_web::web;
use crate::handlers::{attendance_handler, auth_handler, dashboard_handler, employee_handler, group_handler, health_handler, leave_handler, location_handler, patrol_handler, profile_handler, shift_handler, wifi_handler};
